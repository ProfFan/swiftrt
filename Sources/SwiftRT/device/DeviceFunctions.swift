...
//==============================================================================
/// DeviceQueueFunctions
/// an isolated set of functions which will be targeted to a device
/// associated with a concrete queue implementation
public protocol DeviceQueueFunctions: DeviceQueueBase {
    /// all
