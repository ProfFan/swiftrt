...
public protocol DeviceQueue: DeviceQueueFunctions {}

//==============================================================================
// DeviceQueueBase
// The protocol is split so that DeviceQueueFunctions default implementations
// have access to the queue functions and members
